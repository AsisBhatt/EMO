...
$gatewayURL = 'https://secure.edataexecutivegateway.com/api/v2/three-step';
...
if (empty($_POST['DO_STEP_1']) && empty($_GET['token-id'])) {
    ...
    <html>
      ...
      <h4> Billing Details</h4>
        ...
        <form action="" method="post">
          ...
          <tr><td>Company</td><td><input type="text" name="billing-address-company" value="Unika info"></td></tr>
          <tr><td>First Name </td><td><input type="text" name="billing-address-first-name" value="Millon"></td></tr>
          <tr><td>Last Name </td><td><input type="text" name="billing-address-last-name" value="Rehman"></td></tr>
          ...
          <tr><td>Email Address </td><td><input type="text" name="billing-address-email" value="millon@gmail.com"></td></tr>

          <tr><td><h4><br /> Shipping Details</h4>
          <tr><td>Company</td><td><input type="text" name="shipping-address-company" value="Unika info"></td></tr>
          <tr><td>First Name </td><td><input type="text" name="shipping-address-first-name" value="Millon"></td></tr>
          <tr><td>Last Name </td><td><input type="text" name="shipping-address-last-name" value="Rehman"></td></tr>
          ...
          <tr><td colspan="2"> </td>
          <tr><td colspan="2" align=center>Total Amount $10.00 </td></tr>
    ...
    appendXmlNode($xmlRequest, $xmlSale, 'amount', '10.00');
