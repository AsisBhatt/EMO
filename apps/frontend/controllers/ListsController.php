...
class ListsController extends Controller
{
    ...
    public function actionSubscribe_confirm($list_uid, $subscriber_uid, $do = null)
    {
        ...
        if ($do != 'subscribe-back') {
            ...
            if ($list->customerNotification->subscribe == ListCustomerNotification::TEXT_YES && !empty($list->customerNotification->subscribe_to) && ($server = DeliveryServer::pickServer(0, $list, $dsParams))) {
                // since 1.3.4.6
                $fields = array();
                $listFields = ListField::model()->findAll(array(
