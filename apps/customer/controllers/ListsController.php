...
class ListsController extends Controller
{
    ...
    public function actionIndex()
    {
		...
		$list_type = ($request->getQuery('type') !='' ? $request->getQuery('type') : '');
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && $request->getPost($list->modelName)) {
            ...
            if (!$hasErrors) {
				...
				CommonHelper::setActivityLogs('Lists Create '.str_replace(array('{{','}}'),'',$list->tableName()),$list->list_id,$list->tableName(),'Lists Create',(int)Yii::app()->customer->getId());
        ...
        $this->setData(array(
            ...
            'pageBreadcrumbs'   => array(
                Yii::t('lists', 'Lists') => $this->createUrl('lists/index/type/'.$list_type),
    ...
    public function actionUpdate($list_uid)
    {
        ...
        if ($request->isPostRequest && $request->getPost($list->modelName)) {
            ...
            if (!$hasErrors) {
				...
				CommonHelper::setActivityLogs('Lists Update '.str_replace(array('{{','}}'),'',$list->tableName()),$list->list_id,$list->tableName(),'Lists Update',(int)Yii::app()->customer->getId());
    ...
    public function actionCopy($list_uid)
    {
		...
		$return = CommonHelper::setActivityLogs('Lists Copy '.str_replace(array('{{','}}'),'',$list->tableName()),$list->list_id,$list->tableName(),'Lists Copy',(int)Yii::app()->customer->getId());
    ...
    public function actionDelete($list_uid)
    {
        ...
        if ($request->isPostRequest) {
			...
			CommonHelper::setActivityLogs('Lists Delete '.str_replace(array('{{','}}'),'',$list->tableName()),$list->list_id,$list->tableName(),'Lists Delete',(int)Yii::app()->customer->getId());
    ...
    public function loadModel($list_uid)
    {
		...
		$criteria->addInCondition('customer_id', array((int)Yii::app()->customer->getId(),"0"));
        $criteria->addNotInCondition('status', array(Lists::STATUS_PENDING_DELETE));
