...
class PlanController extends Controller
{
    ...
    public function actionIndex()
    {
        $request    = Yii::app()->request;
			...
			$criteria->select = 't.name, t.sms_total,t.email_total,t.validity,t.price,t.list_limit,t.listsend_limit,t.status, t.date_added';
			$criteria->group = 't.plan_id';
			//$criteria->compare('t.list_id', $slist_id);
			//$criteria->compare('t.status', 'confirmed');
			//$criteria->order = 't.subscriber_id DESC';
			$cplans = $mplan->findAll($criteria);	
			//print_r($cplans); die('ok');
        ...
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('plan', 'View All Plans'),
        ...
        $this->render('list', compact('plan','cplans'));
    }
