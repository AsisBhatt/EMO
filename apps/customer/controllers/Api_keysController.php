...
class Api_keysController extends Controller
{
    ...
    public function actionGenerate()
    {
		...
		CommonHelper::setActivityLogs('Generate '.$model->tableName(),$model->key_id,$model->tableName(),'Generate',Yii::app()->customer->getId());
    ...
    public function actionUpdate($id)
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($model->modelName, array()))) {
			...
			CommonHelper::setActivityLogs('Update '.$model->tableName(),$id,$model->tableName(),'Update',Yii::app()->customer->getId());
    ...
    public function actionDelete($id)
    {
		...
		CommonHelper::setActivityLogs('Delete '.$model->tableName(),$id,$model->tableName(),'Delete',Yii::app()->customer->getId());
