...
class CampaignsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($campaign->modelName, array()))) {
            ...
            if ($campaign->save()) {
				...
				CommonHelper::setActivityLogs('Email Campaign Create '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Create',(int)Yii::app()->customer->getId());
				...
				CommonHelper::setActivityLogs('Email Campaign Create Error '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Create Error',(int)Yii::app()->customer->getId());
    ...
    public function actionUpdate($campaign_uid)
    {
        ...
        if (!$campaign->editable) {
			...
			CommonHelper::setActivityLogs('Email Campaign Update Not Editable '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Update Not Editable',(int)Yii::app()->customer->getId());
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($campaign->modelName, array()))) {
            ...
            if ($campaign->save()) {
				...
				CommonHelper::setActivityLogs('Email Campaign Update '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Update',(int)Yii::app()->customer->getId());
    ...
    public function actionSetup($campaign_uid)
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($campaign->modelName, array()))) {
            ...
            if ($campaign->save() && $campaign->option->save()) {
				...
				CommonHelper::setActivityLogs('Email Campaign Setup '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Setup',(int)Yii::app()->customer->getId());
        ...
        if ($do === 'select') {
            ...
            if ($template_uid = $request->getQuery('template_uid')) {
                ...
                if (!empty($selectedTemplate)) {
					...
					CommonHelper::setActivityLogs('Email Campaign Template '.str_replace(array('{{','}}'),'',$campaignTemplate->tableName()),$campaignTemplate->template_id,$campaignTemplate->tableName(),'Email Campaign Template',(int)Yii::app()->customer->getId());
            ...
            if ($request->isPostRequest && ($attributes = (array)$request->getPost($template->modelName, array()))) {
                ...
                if (empty($errors) && $template->save()) {
					...
					CommonHelper::setActivityLogs('Email Campaign Template '.str_replace(array('{{','}}'),'',$template->tableName()),$template->template_id,$template->tableName(),'Email Campaign Template',(int)Yii::app()->customer->getId());
    ...
    public function actionConfirm($campaign_uid)
    {
        ...
        if (!$hasError && $request->isPostRequest) {
            ...
            if ($campaign->save()) {
				...
				CommonHelper::setActivityLogs('Email Campaign Confirm '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Confirm',(int)Yii::app()->customer->getId());
    ...
    public function actionMerge_lists($campaign_uid)
    {
        ...
        if (empty($subscribers)) {
			...
			CommonHelper::setActivityLogs('Email Campaign Merge_list '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Merge_list',(int)Yii::app()->customer->getId());
    ...
    public function actionTest($campaign_uid)
    {
        ...
        foreach ($emails as $email) {
            ...
            $serverLog = null;
            $sent = false;
			//DeliveryServer::DELIVERY_FOR_CAMPAIGN_TEST
			// echo '<pre>';
			// print_r($server);
			// echo '</pre>';
			// exit;
    ...
    public function actionCopy($campaign_uid)
    {
        ...
        if ($copied) {
			...
			CommonHelper::setActivityLogs('Email Campaign Copy '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Copy',(int)Yii::app()->customer->getId());
    ...
    public function actionDelete($campaign_uid)
    {
        ...
        if ($campaign->removable) {
			...
			CommonHelper::setActivityLogs('Email Campaign Delete '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Delete',(int)Yii::app()->customer->getId());
    ...
    public function actionPause_unpause($campaign_uid)
    {
		...
		CommonHelper::setActivityLogs('Email Campaign Pause_unpause '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Pause_unpause',(int)Yii::app()->customer->getId());
    ...
    public function actionResume_sending($campaign_uid)
    {
        ...
        if ($campaign->isProcessing) {
			...
			CommonHelper::setActivityLogs('Email Campaign Resume_sending '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Resume_sending',(int)Yii::app()->customer->getId());
        }
    ...
    public function actionMarksent($campaign_uid)
    {
        ...
        if ($campaign->getCanBeMarkedAsSent()) {
			...
			CommonHelper::setActivityLogs('Email Campaign Marksent '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Marksent',(int)Yii::app()->customer->getId());
        }
    ...
    public function actionBulk_action()
    {
        ...
        if ($action == Campaign::BULK_ACTION_DELETE && count($items)) {
            ...
            foreach ($items as $item) {
				...
				CommonHelper::setActivityLogs('Email Campaign Bulk_action Delete '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Bulk_action Delete',(int)Yii::app()->customer->getId());
            ...
            foreach ($items as $item) {
				...
				CommonHelper::setActivityLogs('Email Campaign Bulk_action Copy '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Bulk_action Copy',(int)Yii::app()->customer->getId());
            ...
            foreach ($items as $item) {
				...
				CommonHelper::setActivityLogs('Email Campaign Bulk_action Pause Unpause '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Bulk_action Pause Unpause',(int)Yii::app()->customer->getId());
            ...
            foreach ($items as $item) {
				...
				CommonHelper::setActivityLogs('Email Campaign Bulk_action Mark Sent '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Bulk_action Mark Sent',(int)Yii::app()->customer->getId());
    ...
    public function actionGoogle_utm_tags($campaign_uid)
    {
		...
		CommonHelper::setActivityLogs('Email Campaign Google_utm_tags '.str_replace(array('{{','}}'),'',$campaign->tableName()),$campaign->campaign_id,$campaign->tableName(),'Email Campaign Google_utm_tags',(int)Yii::app()->customer->getId());
