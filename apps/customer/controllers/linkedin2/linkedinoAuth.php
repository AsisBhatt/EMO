...
class LinkedIn {
  ...
  function setStatus($status) {
   ...
   /*------------custom----------*/
   function getTimeline($comapnyid = null) {	  

	$company_url = $this->base_url . "/v1/companies/".$comapnyid."/updates/?format=json" ;
	
	//$company_url = $this->base_url . "/v1/companies/".$_SESSION['l_page_id']."/updates/key=".$comapnyid."?format=json" ;
	//$company_url = $this->base_url . "/v1/companies/13248997/updates/key=UPDATE-c13248997-6235619457843195904?format=json" ;
    ...
    function getReport($postid = null) {	  
		//http://api.linkedin.com/v1/companies/13248997/updates/key={update-key}/update-comments 
			 	 
	 
	$company_url = $this->base_url . "/v1/companies/".$_SESSION['l_page_id']."/updates/key=".$postid."?format=json" ;
	//$company_url = $this->base_url . "/v1/companies/13248997/updates/key=UPDATE-c13248997-6235619457843195904?format=json" ;
