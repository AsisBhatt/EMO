...
class Email_blacklistController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($email->modelName, array()))) {
            ...
            if (!$email->save()) {
				...
				CommonHelper::setActivityLogs('Email_blacklist Create '.str_replace(array('{{','}}'),'',$email->tableName()),$email->email_id,$email->tableName(),'Email_blacklist Create',(int)Yii::app()->customer->getId());
    ...
    public function actionUpdate($email_uid)
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($email->modelName, array()))) {
            ...
            if (!$email->save()) {
				...
				CommonHelper::setActivityLogs('Email_blacklist Update '.str_replace(array('{{','}}'),'',$email->tableName()),$email->email_id,$email->tableName(),'Email_blacklist Update',(int)Yii::app()->customer->getId());
    ...
    public function actionDelete($email_uid)
    {
		...
		CommonHelper::setActivityLogs('Email_blacklist Delete '.str_replace(array('{{','}}'),'',$email->tableName()),$email->email_id,$email->tableName(),'Email_blacklist Delete',(int)Yii::app()->customer->getId());
    ...
    public function actionBulk_action()
    {
        ...
        if ($action == CustomerEmailBlacklist::BULK_ACTION_DELETE && count($items)) {
            ...
            foreach ($items as $item) {
				...
				CommonHelper::setActivityLogs('Email_blacklist Bulk_action Delete '.str_replace(array('{{','}}'),'',$email->tableName()),$email->email_id,$email->tableName(),'Email_blacklist Bulk_action Delete',(int)Yii::app()->customer->getId());
    ...
    public function actionDelete_all()
    {
        ...
        while (!empty($models)) {
            foreach ($models as $model) {
				...
				CommonHelper::setActivityLogs('Email_blacklist Remove all '.str_replace(array('{{','}}'),'',$model->tableName()),$model->email_id,$model->tableName(),'Email_blacklist Remove all',(int)Yii::app()->customer->getId());
    ...
    public function actionImport()
    {
		...
		CommonHelper::setActivityLogs('Email_blacklist Import Count  '.str_replace(array('{{','}}'),'',$table_name),$totalImport,$table_name,'Email_blacklist Import Count',(int)Yii::app()->customer->getId());
