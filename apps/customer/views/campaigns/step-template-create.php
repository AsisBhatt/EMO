...
if ($viewCollection->renderContent) { 
		...
		<div class="portlet-title">
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					<?php echo CHtml::link(Yii::t('email_templates', 'Import html from url'), '#template-import-modal', array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'data-toggle' => 'modal', 'title' => Yii::t('email_templates', 'Import html from url')));?>
					...
					<?php echo CHtml::link(Yii::t('campaigns', 'Change/Select template'), array('campaigns/template', 'campaign_uid' => $campaign->campaign_uid, 'do' => 'select'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('campaigns', 'Change/Select template')));?>
					<?php if (!empty($template->content)) { ?>
					<?php echo CHtml::link(Yii::t('campaigns', 'Test template'), '#template-test-email', array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('campaigns', 'Test template'), 'data-toggle' => 'modal'));?>
					<?php } ?>
		...
		<div class="portlet-body">
			...
			<div class="row">
				...
				<?php if (!empty($campaign->option) && $campaign->option->plain_text_email == CampaignOption::TEXT_YES) { ?>
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($template, 'only_plain_text', array('class' => 'control-label'));?>
					...
					<div class="form-group col-lg-6" style="display:<?php echo $template->isOnlyPlainText ? 'none':'';?>;">
						<?php echo $form->labelEx($template, 'auto_plain_text', array('class' => 'control-label'));?>
			...
			<div class="form-group plain-text-version" style="display:<?php echo $template->isOnlyPlainText ? 'block':'none';?>;">
				<?php echo $form->labelEx($template, 'plain_text', array('class' => 'control-label'));?> [<a data-toggle="modal" href="#available-tags-modal"><?php echo Yii::t('lists', 'Available tags');?></a>]
			...
			<div class="form-group template-click-actions-list-fields-container" style="display: none;">
				...
				<div class="col-lg-12 template-click-actions-list-fields-row" data-start-index="<?php echo $index;?>" style="margin-bottom: 10px;">
					<div class="col-lg-4">
						<?php echo $form->labelEx($templateUrlActionListFieldMdl, 'url', array('class' => 'control-label'));?>
					...
					<div class="col-lg-3">
						<?php echo $form->labelEx($templateUrlActionListField, 'field_id', array('class' => 'control-label'));?>
					...
					<div class="col-lg-4">
						<?php echo $form->labelEx($templateUrlActionListFieldMdl, 'field_value', array('class' => 'control-label'));?>
			...
			<div class="form-group template-click-actions-container" style="display: none;">
				...
				<div class="col-lg-12 template-click-actions-row" data-start-index="<?php echo $index;?>" style="margin-bottom: 10px;">
					<div class="col-lg-6">
						<?php echo $form->labelEx($templateUrlActionSub, 'url', array('class' => 'control-label'));?>
						...
						<?php echo $form->error($templateUrlActionSub, 'url', array('class' => 'control-label'));?>
					</div>
					<div class="col-lg-1">
						<?php echo $form->labelEx($templateUrlActionSub, 'action', array('class' => 'control-label'));?>
					...
					<div class="col-lg-4">
						<?php echo $form->labelEx($templateUrlActionSub, 'list_id', array('class' => 'control-label'));?>
			...
			<div class="pull-right">
				<?php if (!empty($templateContentUrls)) { ?>
				<button type="button" class="btn green btn-template-click-actions-list-fields">
				...
				<?php } ?>
				<?php if (!empty($templateContentUrls)) { ?>
				<button type="button" class="btn green btn-template-click-actions">
				...
				<?php } ?>
				<?php echo CHtml::link(Yii::t('campaigns', 'Google UTM tags'), '#google-utm-tags-modal', array('class' => 'btn green', 'data-toggle' => 'modal', 'title' => Yii::t('campaigns', 'Google UTM tags')));?>
				<?php if (!empty($campaign->option) && $campaign->option->plain_text_email == CampaignOption::TEXT_YES) { ?>
				<button type="button" class="btn green btn-plain-text" data-showtext="<?php echo Yii::t('campaigns', 'Show plain text version');?>" data-hidetext="<?php echo Yii::t('campaigns', 'Hide plain text version');?>" style="display:<?php echo $template->isOnlyPlainText ? 'none':'';?>;"><?php echo Yii::t('campaigns', 'Show plain text version');?></button>
				<?php } ?>
				<button type="submit" id="is_next" name="is_next" value="0" class="btn green btn-submit btn-go-next" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>"><?php echo Yii::t('campaigns', 'Save template changes');?></button>
			</div>
			<div class="clearfix"><!-- --></div>
			<?php 
			/**
			...
			?>
			<div class="box-footer margin-top-20">
				<div class="wizard">
					<ul class="steps">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <div class="form-group">
                     <?php echo CHtml::label(Yii::t('campaigns', 'Recipient(s)'), 'email', array('class' => 'control-label'));?>
                 ...
                 <div class="clearfix"><!-- --></div>
                 <div class="form-group">
                     <?php echo CHtml::label(Yii::t('campaigns', 'From email (optional)'), 'from_email', array('class' => 'control-label'));?>
            ...
            <div class="modal-footer">
              <button type="button" class="btn dark btn-outline" data-dismiss="modal"><?php echo Yii::t('app', 'Close');?></button>
              <button type="button" class="btn green btn-submit" onclick="$('#template-test-form').submit();" data-loading-text="<?php echo Yii::t('app', 'Please wait, loading...');?>"><?php echo Yii::t('campaigns', 'Send test');?></button>
            </div>
          </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php if (!empty($campaign->option) && $campaign->option->plain_text_email == CampaignOption::TEXT_YES) { ?>
                <div class="form-group">
                    <?php echo $form->labelEx($templateUp, 'auto_plain_text', array('class' => 'control-label'));?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <div class="form-group">
                    <?php echo $form->labelEx($template, 'from_url', array('class' => 'control-label'));?>
            ...
            <div class="modal-footer">
              <button type="button" class="btn dark outline" data-dismiss="modal"><?php echo Yii::t('app', 'Close');?></button>
              <button type="button" class="btn green btn-submit" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>" onclick="$('#import-template-form').submit();"><?php echo Yii::t('email_templates',  'Import');?></button>
            </div>
          </div>
        </div>
    </div>
    ...
    <div id="template-click-actions-list-fields-template" style="display: none;">
        <div class="col-lg-12 template-click-actions-list-fields-row" data-start-index="{index}" style="margin-bottom: 10px;">
            <div class="col-lg-4">
                <?php echo $form->labelEx($templateUrlActionListField, 'url', array('class' => 'control-label'));?>
            ...
            <div class="col-lg-4">
                <?php echo $form->labelEx($templateUrlActionListField, 'field_value', array('class' => 'control-label'));?>
    ...
    <div id="template-click-actions-template" style="display: none;">
        <div class="col-lg-12 template-click-actions-row" data-start-index="{index}" style="margin-bottom: 10px;">
            <div class="col-lg-6">
                <?php echo $form->labelEx($templateUrlActionSubscriber, 'url', array('class' => 'control-label'));?>
            ...
            <div class="col-lg-1">
                <?php echo $form->labelEx($templateUrlActionSubscriber, 'action', array('class' => 'control-label'));?>
            ...
            <div class="col-lg-4">
                <?php echo $form->labelEx($templateUrlActionSubscriber, 'list_id', array('class' => 'control-label'));?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo Yii::t('campaigns', 'Insert your pattern');?>:</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn dark btn-outline" data-dismiss="modal"><?php echo Yii::t('app', 'Close');?></button>
              <button type="button" class="btn green" onclick="$('#google-utm-tags-form').submit(); return false;"><?php echo Yii::t('campaigns', 'Parse links and set pattern');?></button>
            </div>
          </div>
        </div>
    </div>
