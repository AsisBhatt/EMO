    ...
    if ($collection->renderForm) {
		...
		<div class="portlet-body">
			...
			<div class="row">
				...
				<div class="form-group col-lg-6 jqcron-holder">
					<?php echo $form->checkbox($campaign->option, 'cronjob_enabled', $campaign->option->getHtmlOptions('cronjob_enabled', array('uncheckValue' => 0, 'class' => '', 'style' => 'margin-top:3px;')));?>
					<?php echo $form->labelEx($campaign->option, 'cronjob');?>
