    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="height:380px; overflow-y:scroll;">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getUnsubscribesCount(true);?>
					</span>
					<?php echo Yii::t('campaign_reports', 'Unsubscribe');?>
				</li>
                <li class="list-group-item active panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getUnsubscribesRate(true);?>%
					</span>
					<?php echo Yii::t('campaign_reports', 'Unsubscribe rate');?>
				</li>
            </ul>
        </div>
        <div class="panel-footer">
			<a href="<?php echo $this->createUrl('campaign_reports/unsubscribe', array('campaign_uid' => $campaign->campaign_uid));?>" class="btn green"><?php echo Yii::t('campaign_reports', 'View details');?></a>
        </div>
    </div>
</div>