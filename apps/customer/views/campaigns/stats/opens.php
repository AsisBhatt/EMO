    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="height:380px; overflow-y:scroll;">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getUniqueOpensCount(true);?>
					</span>
					<?php echo Yii::t('campaign_reports', 'Unique opens');?>
				</li>
                <li class="list-group-item active panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getUniqueOpensRate(true);?>%
					</span>
					<?php echo Yii::t('campaign_reports', 'Unique opens rate');?>
				</li>
                <li class="list-group-item panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getOpensCount(true);?>
					</span>
					<?php echo Yii::t('campaign_reports', 'All opens');?>
				</li>
                <li class="list-group-item active panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getOpensRate(true);?>%
					</span>
					<?php echo Yii::t('campaign_reports', 'All opens rate');?>
				</li>
                <?php if ($campaign->stats->getIndustryOpensRate()) { ?>
                <li class="list-group-item panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getIndustryOpensRate(true);?>%
					</span>
                ...
                <li class="list-group-item active panel-title">
					<span class="badge">
						<?php echo $campaign->stats->getOpensToClicksRate(true);?>%
					</span>
					<?php echo Yii::t('campaign_reports', 'Opens to clicks rate');?>
				</li>
            </ul>
        </div>
        <div class="panel-footer text-right">
			<a href="<?php echo $this->createUrl('campaign_reports/open', array('campaign_uid' => $campaign->campaign_uid));?>" class="btn green"><?php echo Yii::t('campaign_reports', 'View details');?></a>
        </div>
    </div>
</div>