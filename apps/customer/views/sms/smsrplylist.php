	...
	<div class="modal-dialog modal-sm">
	  <div class="modal-content">
		<div class="modal-header">
		  ...
		  <h4 class="modal-title"><?php echo Yii::t('smsreply_list', 'SMS Reply');?></h4>
		</div>
		<div class="modal-body">
			<?php
			$form = $this->beginWidget('CActiveForm', array(
				'action'        => array('sms/replysms'),
				'htmlOptions'   => array(
					'id'        => 'smsrply_form',
				),
			));
			?>
			<div class="form-group" id="sms_reply_ele">
				<div class="row">
					<div class="form-group col-lg-12">
						<?php echo CHtml::label('Mobile', array('class' => 'control-label'));?>
						<?php echo CHtml::textField('mobile', '', array('id' => 'reply_number_box', 'class' => 'form-control form-filter input-sm')); ?>
					</div>
					<div class="form-group col-lg-12">
						<?php echo CHtml::label('Message', array('class' => 'control-label'));?>
						<?php 
							echo CHtml::textArea('message', $content,
							 array(
									'id'=>'widget', 
		...
		<div class="modal-footer" id="sms_reply_ele_button">
		  <button type="button" class="btn btn-default" data-dismiss="modal" onclick="javascript:window.location.reload()"><?php echo Yii::t('app', 'Close');?></button>
		  <button type="button" class="btn btn-primary btn-submit" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>" onclick="reply_sms();"><?php echo Yii::t('list_import', 'Send')?></button>
		</div>
	  </div>
	</div>
</div>
