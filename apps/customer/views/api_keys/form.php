...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					<?php if (!$model->isNewRecord) { ?>
						<?php echo CHtml::link(Yii::t('app', 'Create new'), array('api_keys/generate'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Create new')));?>
					<?php } ?>
					<?php echo CHtml::link(Yii::t('app', 'Cancel'), array('api_keys/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Cancel')));?>
				</div>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="row">
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($model, 'ip_whitelist', array('class' => 'control-label'));?>
					<?php echo $form->textArea($model, 'ip_whitelist', $model->getHtmlOptions('ip_whitelist')); ?>
					<?php echo $form->error($model, 'ip_whitelist');?>
				</div>				
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($model, 'ip_blacklist', array('class' => 'control-label'));?>
