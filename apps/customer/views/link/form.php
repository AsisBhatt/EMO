    ...
    if ($collection->renderForm) {
		...
		<div class="portlet-title">
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					...
					<?php } ?>
					<?php echo CHtml::link(Yii::t('app', 'Cancel'), array('link/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Cancel')));?>
				</div>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="form-group">
				<?php echo $form->labelEx($link, 'url', array('class' => 'control-label'));?>
				<?php echo $form->textField($link, 'url', $link->getHtmlOptions('url')); ?>
