...
if ($viewCollection->renderContent) { 
    ...
    if ($collection->renderForm) {
		...
		<div class="form-actions">
			...
			<a href="<?php echo $this->createUrl('guest/forgot_password')?>" class="forget-password"><?php echo Yii::t('customers', 'Forgot password?');?></a>
		</div>
		...
		<!----custom code----->
            <div class="box-footer">
                <div class="pull-left">
                    <a target="_blank" href="/privacy-policy.php" class="btn green btn-outline btn-circle btn-sm">Privacy Policy </a>
                </div>
				<div class="pull-right">
                    <a target="_blank" href="/terms-and-condition.php" class="btn green btn-outline btn-circle btn-sm">Terms & Conditions</a>
                </div>
            </div>
		<!----custom code----->
		<div class="clearfix"></div>
		...
		<div class="create-account">
			<p>
				<?php if ($registrationEnabled) { ?>
					<a href="<?php echo $this->createUrl('guest/register')?>" class="uppercase"><?php echo Yii::t('customers', 'Create an account');?></a>
				<?php } ?>
			</p>
		</div>	
