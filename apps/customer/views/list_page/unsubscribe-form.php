    ...
    <div class="alert alert-success margin-bottom-20">
		...
		<div class="row">
			...
			<div class="col-lg-2 text-right">
				<a class="btn green btn-flat" href="<?php echo Yii::app()->apps->getAppUrl('frontend', 'lists/'.$list->list_uid.'/unsubscribe', true);?>" target="_blank"><?php echo Yii::t('list_pages', 'Preview it now!');?></a>
			</div>
        </div>
    </div>
    <?php 
