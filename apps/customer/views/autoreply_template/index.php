...
$template_type = Yii::app()->request->getQuery('type');
?>
	<script>
			...
			$.ajax({
				...
				success: function(data){
					if(data.SUCCESS){
						...
						$("#response_ele").show();
						window.location.href = '<?php echo $this->createUrl('autoreply_template/index/type/'.$template_type); ?>';
					}else if(data.ERROR){
		...
		<div class="actions">
			<div class="btn-group btn-group-devided">
				<?php //if($autoreply_template->isNewRecord()){ ?>
					<?php echo CHtml::link(Yii::t('app', 'Create'), array('autoreply_template/create/type/'.$template_type), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Create')));?>
				<?php //} ?>
				<?php echo CHtml::link(Yii::t('app', 'Refresh'), array('autoreply_template/index/type/'.$template_type), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Refresh')));?>
			</div>
		</div>
	</div>
					...
					array(
						...
						'buttons'   => array(
							...
							'delete' => array(
								...
								'url'       => 'Yii::app()->createUrl("autoreply_template/delete", array("id" => $data->auto_temp_id,"type" => strtolower($data->auto_temp_type)))',
								'imageUrl'  => null,
