		...
		*/
		...
		<div class="portlet-body">
			...
			<div class="vik form-group col-lg-12">
				<div class="col-lg-3">
					 <span style="color:green; font-weight:bold"> <h2>Favorited : </h2></span>
				</div>
				<div class="col-lg-8">
					<button class="btn btn-info "> 
					<h4>
					<?php if(@$report->favorite_count){
						$fcount = @$report->favorite_count; 
					}else{
						$fcount = '0'; 
					}
					echo $fcount;
			...
			<div class="vik form-group col-lg-12">
				<div class="col-lg-3">
					 <span style="color:red; font-weight:bold"> <h2>Retweeted : </h2></span>
				</div>
				<div class="col-lg-8">
					<button class="btn btn-info "> <h4> 
					<?php if(@$report->retweeted){
						$rcount = @$report->retweeted; 
					}else{
						$rcount = '0'; 
					}
					echo $rcount;
