		...
		<div class="portlet-body">
			...
			<div class="vik form-group table-scrollable">
				...
				<table class="table table-bordered table-hover">
					<tr>
						<td style="color:red"><strong><?php echo $report->user->name; ?></strong> ,<?php echo $report->created_at; ?> </td>
					</tr>
					<tr>
					...
					<tr>
						<td>
						<?php foreach($report->entities->media as $media){ ?>
							<a target="_blank" href="<?php echo $media->url; ?>">
							<img style="height:250px;width:400px" src="<?php echo $media->media_url; ?>" />
							</a> 
							<br>
						<?php } ?>
						</td>
					...
					<tr>
						<td>Retweet: <?php echo $report->retweet_count; ?>  &nbsp; &nbsp; Favorite: <?php echo $report->favorite_count; ?> </td>
					</tr>
				</table>
				<?php } ?>
			</div>
