    ...
    if ($collection->renderForm) {
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'name', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'website', array('class' => 'control-label'));?>
		...
		<div class="portlet-body">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'address_1', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'address_2', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6 city-wrap">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'city', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6 zip-wrap">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'zip_code', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'country_id', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6 zone-name-wrap">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'zone_name', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'zone_id', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'zone', array('class' => 'control-label')); ?>
		...
		<div class="portlet-body">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'phone', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'fax', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'type_id', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'vat_number', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'portal_customer', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'flowroute_sms_num', array('class' => 'control-label'));?>
						<?php echo $form->textField($company, 'flowroute_sms_num', $company->getHtmlOptions('flowroute_sms_num',array('disabled' =>'disabled'))); ?>
						<?php echo $form->error($company, 'flowroute_sms_num');?>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'credit_street_address', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'credit_zip', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'credit_city', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'credit_state', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'credit_county', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'credit_country', array('class' => 'control-label'));?>
		...
		<div class="portlet-body">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php //echo $form->labelEx($company, 'credit_last_four', array('class' => 'control-label'));?>
						<?php //echo $form->textField($company, 'credit_last_four', $company->getHtmlOptions('credit_last_four')); ?>
						<?php //echo $form->error($company, 'credit_last_four');?>
					</div>
				</div>
			</div>
		</div>
		<div class="portlet-body">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'acquisition_source', array('class' => 'control-label'));?>
				...
				<div class="col-lg-6">
					<div class="form-group">
						<?php echo $form->labelEx($company, 'comments', array('class' => 'control-label'));?>
