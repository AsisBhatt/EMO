		...
		<div class="portlet-body">
			...
			<div class="row">
				<div class="form-group col-lg-6">
					...
					<?php echo $form->textField($customer, 'first_name', $customer->getHtmlOptions('first_name', array('disabled' => 'disabled'))); ?>
					<?php echo $form->error($customer, 'first_name');?>
				</div>   
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($customer, 'last_name', array('class' => 'control-label'));?>
					<?php echo $form->textField($customer, 'last_name', $customer->getHtmlOptions('last_name', array('disabled' => 'disabled'))); ?>
					<?php echo $form->error($customer, 'last_name');?>
				</div>   				
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($customer, 'email', array('class' => 'control-label'));?>
					<?php echo $form->textField($customer, 'email', $customer->getHtmlOptions('email', array('disabled' => 'disabled'))); ?>
					<?php echo $form->error($customer, 'email');?>
				</div>
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($customer, 'mobile', array('class' => 'control-label'));?>
					<?php echo $form->textField($customer, 'mobile', $customer->getHtmlOptions('mobile', array('disabled' => 'disabled'))); ?>
					<?php echo $form->error($customer, 'mobile');?>
				</div>				
				<!--<div class="form-group col-lg-6">
					<?php //echo $form->labelEx($customer, 'confirm_email', array('class' => 'control-label'));?>
				...
				<div class="form-group col-lg-6">
					<div class="row">
						...
						<div class="col-lg-10">
							<?php echo $form->labelEx($customer, 'new_avatar_1');?>
							<?php echo $form->fileField($customer, 'new_avatar_1', $customer->getHtmlOptions('new_avatar_1')); ?>
							<?php echo $form->error($customer, 'new_avatar_1');?>    
						</div>
					</div>
				</div>
			</div>
