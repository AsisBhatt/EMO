	...
	<div class="portlet-title">
		...
		<div class="actions">
			<div class="btn-grop btn-group-devided">
				...
				<?php echo CHtml::link(Yii::t('app', 'Refresh'), array('tracking_domains/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Refresh')));?>
			</div>
		</div>
	</div>
