...
if ($viewCollection->renderContent) { ?>
    <div class="table-scrollable subscribers-table">
                ...
                <tr>
                    ...
                    <?php 
                        ...
                        if ($column['field_type'] == 'text') {
                            echo CHtml::textField('filter['.$column['field_id'].']', $column['value'], ['class' => 'form-control form-filter input-sm']);
                        } elseif ($column['field_type'] == 'select') {
                            echo CHtml::dropDownList('filter['.$column['field_id'].']', $column['value'], $column['options'], ['class' => 'form-control form-filter input-sm']);
