        ...
        <div class="portlet-body">
			<div class="row">
			   <div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 fb_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/facebook'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 tw_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/twitter'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 in_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/linkedin'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 youtube_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/youtube'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 instagram_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/instagram'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 google_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/google_plus'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 myspace_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/myspace'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 pinterest_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/pinterest'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 tumblr_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/tumblr'); ?>">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 snapchat_bg margin-bottom-20" href="<?php echo $this->createUrl('socialmedia/create/type/snapchat'); ?>">
						<div class="visual">
