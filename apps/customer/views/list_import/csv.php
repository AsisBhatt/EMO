...
<div class="alert alert-success">
    ...
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-dark sbold uppercase">
                <?php echo Yii::t('list_import', 'CSV import progress');?> 
            </span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body" id="csv-import" data-model="<?php echo $import->modelName;?>" data-pause="<?php echo (int)$pause;?>" data-iframe="<?php echo $this->createUrl('list_import/ping');?>" data-attributes='<?php echo CJSON::encode($import->attributes);?>'>
        <span class="counters">
