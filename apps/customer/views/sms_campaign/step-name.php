		...
		<div class="portlet-title">
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					<?php 
						echo CHtml::link(Yii::t('app', 'Cancel'), array('dashboard/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Cancel')));
					?>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="wizard">
						...
						<?php } else { ?>
						<ul class="steps">
							<li class="active"><a href="<?php echo $this->createUrl('sms_campaign/update', array('id' => $smscampaign->sms_campaign_id));?>"><?php echo Yii::t('sms_campaign', 'Details');?></a><span class="chevron"></span></li>
							<li><a href="<?php echo $this->createUrl('sms_campaign/setup', array('sms_campaign_id' => $smscampaign->sms_campaign_id));?>"><?php echo Yii::t('sms_campaigns', 'Setup');?></a><span class="chevron"></span></li>
