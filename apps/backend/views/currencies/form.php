		...
		<div class="portlet-title">
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					...
					<?php echo CHtml::link(Yii::t('app', 'Create new'), array('currencies/create'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Create new')));?>
					<?php } ?>
					<?php echo CHtml::link(Yii::t('app', 'Cancel'), array('currencies/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Cancel')));?>
				</div>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="row">
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($currency, 'name', array('class' => 'control-label'));?>
					<?php echo $form->textField($currency, 'name', $currency->getHtmlOptions('name')); ?>
					<?php echo $form->error($currency, 'name');?>
				</div>        
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($currency, 'code', array('class' => 'control-label'));?>
			...
			<div class="row">
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($currency, 'is_default', array('class' => 'control-label'));?>
				...
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($currency, 'status', array('class' => 'control-label'));?>
