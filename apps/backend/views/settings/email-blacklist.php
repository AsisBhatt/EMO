...
if ($viewCollection->renderContent) {
			...
			<div class="portlet-title">
				<div class="caption">
					<span class="caption-subject font-dark sbold uppercase">
						<?php echo Yii::t('settings', 'Email blacklist settings')?>
					</span>
				</div>
			</div>
            <div class="portlet-body">
                ...
                <div class="row">
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($blacklistModel, 'local_check', array('class' => 'control-label'));?>
					...
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($blacklistModel, 'remote_check', array('class' => 'control-label'));?>
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        <span class="caption-subject font-dark sbold uppercase">
							<?php echo Yii::t('settings', 'Available DNSBL services');?>:
						</span>
                    </div>
                    <div class="actions">
						<div class="btn-group btn-group-devided">
							<a href="javascript:;" class="btn btn-transparent grey-salsa btn-outline btn-circle btn-sm add-dnsbl"><?php echo Yii::t('settings', 'Add new service');?></a>
						</div>
                    </div>                    
                </div>
				...
				<div class="row">
					...
					<?php foreach ($blacklistModel->remote_dnsbls as $dnsbl) { ?>
						<div class="form-group col-lg-6">
							<?php echo $form->labelEx($blacklistModel, 'remote_dnsbls', array('class' => 'control-label'));?>
							<div class="row">
								<div class="col-lg-10">
									<?php echo CHtml::textField($blacklistModel->modelName . '[remote_dnsbls][]', $dnsbl, $blacklistModel->getHtmlOptions('remote_dnsbls'));?>
								</div>
								<div class="col-lg-2">
									<a href="javascript:;" class="btn btn-sm green remove-dnsbl"><?php echo Yii::t('app', 'Remove');?></a>
								</div>
							</div>
						</div>
					<?php } ?>
				...
				<div class="row">
					<div class="form-group col-lg-12">
						<?php echo $form->labelEx($blacklistModel, 'regular_expressions', array('class' => 'control-label'));?>
						<div class="alert alert-success margin-bottom-15">
    ...
    <div style="display: none;" id="dnsbl-item" class="row">
        <div class="form-group col-lg-6">
            <?php echo $form->labelEx($blacklistModel, 'remote_dnsbls', array('class' => 'control-label'));?>
			<div class="row">
				<div class="col-lg-10">
