		...
		<div class="portlet-title">
			<div class="caption">
				<span class="caption-subject font-dark sbold uppercase">
					<?php echo Yii::t('settings', 'Customer common settings')?>
				</span>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="row">
				<div class="form-group col-lg-6">
					<?php echo $form->labelEx($model, 'show_articles_menu', array('class' => 'control-label'));?>
			...
			<div class="row">
				<div class="form-group col-lg-12">
					<?php echo $form->labelEx($model, 'notification_message', array('class' => 'control-label'));?>
