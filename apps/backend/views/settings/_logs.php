    ...
    <div class="portlet-title">
        <div class="caption">
			<span class="caption-subject font-dark sbold uppercase">
				<?php echo Yii::t('settings', 'Settings for processing Delivery and Bounce logs')?>
			</span>
		</div>
    </div>
    <div class="portlet-body">
		...
		<div class="row">
			<div class="form-group col-lg-3">
				<?php echo $form->labelEx($cronLogsModel, 'memory_limit', array('class' => 'control-label'));?>
			...
			<div class="form-group col-lg-3">
				<?php echo $form->labelEx($cronLogsModel, 'process_at_once', array('class' => 'control-label'));?>
			...
			<div class="form-group col-lg-3">
				<?php echo $form->labelEx($cronLogsModel, 'max_fatal_errors', array('class' => 'control-label'));?>
			...
			<div class="form-group col-lg-3">
				<?php echo $form->labelEx($cronLogsModel, 'max_soft_errors', array('class' => 'control-label'));?>
		...
		<div class="row">
			<div class="form-group col-lg-3">
				<?php echo $form->labelEx($cronLogsModel, 'max_hard_bounce', array('class' => 'control-label'));?>
			...
			<div class="form-group col-lg-3">
				<?php echo $form->labelEx($cronLogsModel, 'max_soft_bounce', array('class' => 'control-label'));?>
		...
		<div class="row">
			<div class="col-lg-12">
				<a href="#errors-explained-modal" data-toggle="modal" class="btn green btn-sm"><?php echo Yii::t('app', 'Errors explained');?></a>
			</div>
		</div>
    </div>
