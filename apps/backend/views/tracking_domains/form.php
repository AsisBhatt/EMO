    ...
    if ($collection->renderForm) {
		...
		<div class="portlet-title">
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					...
					<?php echo CHtml::link(Yii::t('app', 'Create new'), array('tracking_domains/create'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Create new')));?>
					<?php } ?>
					<?php echo CHtml::link(Yii::t('app', 'Cancel'), array('tracking_domains/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Cancel')));?>
				</div>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="row">
				...
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($domain, 'skipValidation', array('class' => 'control-label'));?>
