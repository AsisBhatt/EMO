		...
		<div class="portlet-body">
			...
			<div class="row">
				<div class="form-group col-lg-4">
					...
					<?php echo $form->error($server, 'timeout', array('class' => 'control-label'));?>
				</div>
				<div class="form-group col-lg-4">
			...
			<div class="row">
				...
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'max_connection_messages', array('class' => 'control-label'));?>
					<?php echo $form->textField($server, 'max_connection_messages', $server->getHtmlOptions('max_connection_messages')); ?>
					<?php echo $form->error($server, 'max_connection_messages');?>
				</div>
			</div>
			<?php 
			/**
