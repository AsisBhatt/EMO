    ...
    if ($collection->renderForm) {
		...
		<div class="portlet-body">
			...
			<div class="row">
				...
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'vhost', array('class' => 'control-label'));?>
			...
			<div class="row">
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'use_for', array('class' => 'control-label'));?>
			...
			<div class="row">
				...
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'queue', array('class' => 'control-label'));?>
					<?php echo $form->textField($server, 'queue', $server->getHtmlOptions('queue')); ?>
					<?php echo $form->error($server, 'queue');?>
				</div>
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'exchange', array('class' => 'control-label'));?>
			...
			<div class="row">
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'exchange_type', array('class' => 'control-label'));?>
					<?php echo $form->textField($server, 'exchange_type', $server->getHtmlOptions('exchange_type')); ?>
					<?php echo $form->error($server, 'exchange_type');?>
				</div>
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'assigned_ips', array('class' => 'control-label'));?>
			...
			<div class="row">	
				...
				<div class="form-group col-lg-4">
					<?php echo $form->labelEx($server, 'must_confirm_delivery', array('class' => 'control-label'));?>
			...
			<div class="row">
				<div class="form-group col-lg-12">
					<?php echo $form->labelEx($server, 'ip_to_domains', array('class' => 'control-label'));?>
