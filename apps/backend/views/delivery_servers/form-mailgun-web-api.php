		...
		<div class="portlet-body">
			...
			<div class="row">
				...
				<div class="form-group col-lg-4">
					...
					<?php echo $form->dropDownList($server, 'probability', $server->getProbabilityArray(), $server->getHtmlOptions('probability', array('data-placement' => 'top'))); ?>
