	...
	<div class="portlet-title">
		...
		<div class="actions">
			<div class="btn-group btn-group-devided">
				<?php echo HtmlHelper::accessLink(Yii::t('app', 'Create new'), array('email_templates_gallery/create'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'New')));?>
				<?php
				if (AccessHelper::hasRouteAccess('email_templates_gallery/upload')) {
					echo CHtml::link(Yii::t('email_templates', 'Upload template'), '#template-upload-modal', array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'data-toggle' => 'modal', 'title' => Yii::t('email_templates', 'Upload template')));
				}
				?>
				<?php echo HtmlHelper::accessLink(Yii::t('app', 'Refresh'), array('email_templates_gallery/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Refresh')));?>
			</div>
		</div>
	</div>
	<div class="portlet-body">
		<div class="row">
			<?php foreach ($templates as $model) { ?>
				<div class="col-md-3">
					<div class="panel panel-default panel-template-box" style="height: 270px;" data-id="<?php echo $model->template_id;?>" data-url="<?php echo $this->createUrl('email_templates_gallery/update_sort_order');?>">
						...
						<div class="panel-footer">
							<a href="<?php echo Yii::app()->createUrl("email_templates_gallery/update", array("template_uid" => $model->template_uid));?>" class="btn green btn-xs"><?php echo Yii::t('app', 'Update');?></a>
							&nbsp;<a href="<?php echo Yii::app()->createUrl("email_templates_gallery/copy", array("template_uid" => $model->template_uid));?>" class="btn dark btn-xs"><?php echo Yii::t('app', 'Copy');?></a>
							&nbsp;<a href="<?php echo Yii::app()->createUrl("email_templates_gallery/delete", array("template_uid" => $model->template_uid));?>" class="btn red-mint btn-xs btn-delete-template" data-confirm-text="<?php echo Yii::t('app', 'Are you sure you want to remove this item?')?>"><?php echo Yii::t('app', 'Delete');?></a>
						</div>
					</div>
				</div>
			<?php } ?>
