    ...
    <div id="glance-box" data-source="<?php echo $this->createUrl('dashboard/glance');?>">
        ...
        <div class="portlet-body">
			<div class="row">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 yellow margin-bottom-20" href="javascript:;">
						<div class="visual">
				...
				<div class="col-lg-4 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 purple-intense margin-bottom-20" href="<?php echo $this->createUrl('delivery_servers/index');?>">
						<div class="visual">
							<i class="fa fa-tasks"></i>
						</div>
						<div class="details">
							<div class="number">
								<span data-bind="text: glance.deliveryServers"></span>
							</div>
							<div class="desc"><?php echo Yii::t('dashboard', 'Delivery servers');?></div>
						</div>
						<div class="small-box">
							<div class="small-box-footer">
								<?php echo Yii::t('dashboard', 'More info');?> <i class="fa fa-arrow-circle-right"></i>
