		...
		<div class="portlet-title">
			...
			<div class="actions">
				<div class="btn-group btn-group-devided">
					<?php if (!$monitor->isNewRecord) { ?>
					<?php echo CHtml::link(Yii::t('app', 'Add new'), array('email_blacklist_monitors/create'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Add new')));?>
					<?php } ?>
					<?php echo CHtml::link(Yii::t('app', 'Cancel'), array('email_blacklist_monitors/index'), array('class' => 'btn btn-transparent grey-salsa btn-outline btn-circle btn-sm', 'title' => Yii::t('app', 'Cancel')));?>
				</div>
			</div>
		</div>
