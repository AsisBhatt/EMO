...
class Customer_groupsController extends Controller
{
    ...
    public function actionCreate()
    {
		...
		$smssending      = new CustomerGroupOptionSmsSending();
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($group->modelName, array()))) {
            ...
            try {
                ...
                $models = array($common, $servers, $trackingDomains, $sendingDomains, $lists, $campaigns, $quotaCounters, $sending, $smssending, $cdn);
