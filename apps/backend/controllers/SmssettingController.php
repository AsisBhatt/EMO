...
class SmssettingController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setData(array(
            'pageMetaTitle'   => $this->data->pageMetaTitle . ' | '. Yii::t('messages', 'Sms API Setting'),
            'pageHeading'     => Yii::t('messages', 'Sms API Setting'),
    ...
    public function actionView($id)
    {
        ...
        $this->setData(array(
            'pageMetaTitle'   => $this->data->pageMetaTitle . ' | '. Yii::t('messages', 'View Sms API Setting'),
            'pageHeading'     => Yii::t('messages', 'View Sms API Setting'),
            'pageBreadcrumbs' => array(
                Yii::t('settings', 'Settings') => $this->createUrl('settings/index'),
                Yii::t('smssetting', 'Sms setting')   => $this->createUrl('smssetting/index'),
                Yii::t('app', 'View'),
