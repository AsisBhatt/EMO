...
class CLinkPager extends CBasePager
{
	...
	public function init()
	{
		if($this->nextPageLabel===null)
			$this->nextPageLabel=Yii::t('yii','<i class="fa fa-angle-right"></i>');
		if($this->prevPageLabel===null)
			$this->prevPageLabel=Yii::t('yii','<i class="fa fa-angle-left"></i>');
		if($this->firstPageLabel===null)
			$this->firstPageLabel=Yii::t('yii','<i class="fa fa-angle-double-left"></i>');
		if($this->lastPageLabel===null)
			$this->lastPageLabel=Yii::t('yii','<i class="fa fa-angle-double-right"></i>');
		if($this->header===null)
