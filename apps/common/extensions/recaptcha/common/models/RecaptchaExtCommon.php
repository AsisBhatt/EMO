...
class RecaptchaExtCommon extends FormModel
{
    ...
    public function attributeLabels()
    {
        $labels = array(
            ...
            'enabled_for_registration' => Yii::t('ext_recpatcha', 'Enable for registration'),
            'enabled_for_login'        => Yii::t('ext_recpatcha', 'Enable for login'),
            'enabled_for_forgot'       => Yii::t('ext_recpatcha', 'Enable for forgot password'),
