...
class OptionCustomerRegistration extends OptionBase
{
    ...
    public function rules()
    {
        $rules = array(
			...
			array('default_plan', 'exist', 'className' => 'PricePlan', 'attributeName' => 'plan_id'),
            array('tc_url', 'url'),
    ...
    public function attributeLabels()
    {
        $labels = array(
			...
			'default_plan'              => Yii::t('settings', 'Default plan'),
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
			...
			'default_plan'              => Yii::t('settings', 'Default plan for customer after registration'),
	...
	public function getPlanList()
	{
		...
		$plan_options = array();
		$plans = PricePlan::model()->findAll();
		
		foreach($plans as $plan){
			$plan_options[$plan->plan_id] = $plan->name;
		}
