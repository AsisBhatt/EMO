...
class OptionCommon extends OptionBase
{
    ...
    {
        $rules = array(
            array('site_name, site_tagline, clean_urls, site_status, site_offline_message, api_status, backend_page_size, customer_page_size, default_mailer, show_backend_timeinfo, show_customer_timeinfo, use_tidy', 'required'),
            ...
            array('check_version_update, show_backend_timeinfo, show_customer_timeinfo, use_tidy', 'in', 'range' => array_keys($this->getYesNoOptions())),
